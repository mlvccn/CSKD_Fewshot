...
DATA_DIR = '/data/tianshaoqi24/datasets'
PROJECT='savc'
...
def get_command_line_parser():
    ...
    parser.add_argument('-clip_model_path', type=str, default="pretrain/clip/mini_imageNet.pth", help='pretrained clip model path')
    ...
    parser.add_argument('-incft', action='store_true',default=False, help='incrmental finetuning')
